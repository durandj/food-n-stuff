package com.durandj.foodnstuff.util;
...
/*
 * Taken with love from Pahimar <3
 *
 * https://github.com/pahimar/Equivalent-Exchange-3/blob/1.9.4/src/main/java/com/pahimar/ee3/util/LogHelper.java
 */

public class LogHelper
{
	public static final Marker MOD_MARKER = MarkerManager.getMarker(FoodNStuff.MOD_ID);
	private static final Logger LOGGER = LogManager.getLogger(FoodNStuff.MOD_ID);
